<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $stmt->store_result();
        if ($stmt->num_rows == 1) {
            $stmt->bind_result($name, $descr, $address, $lat, $lon, $tel, $email, $open_time, $close_time);
            $stmt->fetch();
...
?>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li><span class="active"><?php echo $name ?></span></li>
        </ol>
        <div class="row">
            <div class="col-sm-3">
                <div class="box">
                    ...
                    <div>
                        <div>Σήμερα: <strong><?php echo substr($open_time, 0, 5) . " " . substr($close_time, 0, 5) ?></strong></div>
                        <hr />
                ...
                <div class="box">
                    ...
                    <div>
                        <strong>
                        <div><span class="glyphicon glyphicon-earphone"></span> <?php echo $tel ?></div>
                        <div><span class="glyphicon glyphicon-envelope"></span> <?php echo $email ?></div>
                        <hr />
                        <div><span class="glyphicon glyphicon-map-marker"></span> <?php echo $address ?></div>
                        </strong>
            ...
            <div class="col-sm-9">
                <div class="box">
                    ...
                    <div id="lib-content-left">
                        ...
                        <p class="content"><?php echo $descr ?></p>
